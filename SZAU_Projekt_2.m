...
plot_texts = {'Symulacja procesu (dane uczï¿½ce)','Symulacja procesu (dane weryfikujï¿½ce)'};
file_template = '%f %f\n';
...
%     title(strcat(plot_texts{k}, ' - wyjï¿½cie'));
%     xlabel('k');
%     ylabel('y');
%     subplot(2,1,2);
...
subplot(2,1,1);
plot(1:15, y);
title('Prezentacja opoznienia procesu - wyjï¿½cie');
xlabel('k');
ylabel('y');
subplot(2,1,2);
plot(1:15, u);
...
h.Marker='.';
title('Relacja OE wyjï¿½cia procesu i modelu, dane ucz., tryb OE, algorytm BFGS');
xlabel('y_{learning}');
ylabel('y_{mod}');
...
h.Marker='.';
title('Relacja OE wyjï¿½cia procesu i modelu, dane wer., tryb OE, algorytm BFGS');
xlabel('y_{val}');
ylabel('y_{mod}');
...
h = scatter(y_learning,y_vector,0.1);
h.Marker='.';
title('Relacja OE wyjï¿½cia procesu i modelu, dane ucz., tryb OE, algorytm SD');
xlabel('y_{learning}');
ylabel('y_{mod}');
...
h = scatter(y_val,y_vector,0.1);
h.Marker='.';
title('Relacja OE wyjï¿½cia procesu i modelu, dane wer., tryb OE, algorytm SD');
xlabel('y_{val}');
ylabel('y_{mod}');
...
h = scatter(y_learning,y_vector,0.1);
h.Marker='.';
title('Relacja ARX wyjï¿½cia procesu i modelu, dane ucz., tryb ARX, algorytm BFGS');
xlabel('y_{learning}');
ylabel('y_{mod}');
...
h = scatter(y_val,y_vector,0.1);
h.Marker='.';
title('Relacja ARX wyjï¿½cia procesu i modelu, dane wer.,tryb ARX, algorytm BFGS');
xlabel('y_{val}');
ylabel('y_{mod}');
...
h = scatter(y_learning,y_vector,0.1);
h.Marker='.';
title('Relacja OE wyjï¿½cia procesu i modelu, dane ucz., tryb ARX, algorytm BFGS');
xlabel('y_{learning}');
ylabel('y_{mod}');
...
h = scatter(y_val,y_vector,0.1);
h.Marker='.';
title('Relacja OE wyjï¿½cia procesu i modelu, dane wer., tryb ARX, algorytm BFGS');
xlabel('y_{val}');
ylabel('y_{mod}');
...
% hold off;
% if strcmp(sim_type,'OE')
%     title('Symulacja modelu neuronowego dla danych uczï¿½cych w trybie OE');
% end
% if strcmp(sim_type,'ARX')
%     title('Symulacja modelu neuronowego dla danych uczï¿½cych w trybie ARX');
% end
% legend('y_{learning}','y_{model}','u');
% xlabel('t');
% ylabel('y,u');
...
% h.Marker='.';
% if strcmp(sim_type,'OE')
%     title('Relacja wyjï¿½cia procesu i wyjï¿½ciowego modelu, w trybie OE, dane uczï¿½ce');
% end
% if strcmp(sim_type,'ARX')
%     title('Relacja wyjï¿½cia procesu i wyjï¿½ciowego modelu, w trybie ARX, dane uczï¿½ce');
% end
% xlabel('y_{learning}');
% ylabel('y_{mod}');
...
% hold off;
% if strcmp(sim_type,'OE')
%     title('Symulacja modelu neuronowego dla danych weryfikujï¿½cych, w trybie OE');
% end
% if strcmp(sim_type,'ARX')
%     title('Symulacja modelu neuronowego dla danych weryfikujï¿½cych, w trybie ARX');
% end
% legend('y_{val}','y_{model}','u');
% xlabel('t');
% ylabel('y,u');
...
% h.Marker='.';
% if strcmp(sim_type,'OE')
%     title('Relacja wyjï¿½cia procesu i wyjï¿½ciowego modelu, w trybie OE, dane weryfikujï¿½ce');
% end
% if strcmp(sim_type,'ARX')
%     title('Relacja wyjï¿½cia procesu i wyjï¿½ciowego modelu, w trybie ARX, dane weryfikujï¿½ce');
% end
% xlabel('y_{val}');
% ylabel('y_{mod}');
% 
...
plot(1:length(u_learning),u_learning);
hold off;
title('Symulacja modelu MNK dla danych uczï¿½cych');
legend('y_{learning}','y_{model}','u');
xlabel('t');
ylabel('y,u');
...
h.Marker='.';
title('Relacja modelu MNK dla danych uczï¿½cych');
xlabel('y_{learning}');
ylabel('y_{mod}');
...
plot(1:length(u_val),u_val);
hold off;
title('Symulacja modelu MNK dla danych weryfikujï¿½cych');
legend('y_{val}','y_{model}','u');
xlabel('t');
ylabel('y,u');
...
h.Marker='.';
title('Relacja modelu MNK dla danych weryfikujï¿½cych');
xlabel('y_{val}');
ylabel('y_{mod}');
...
hold off;
legend('y', 'y_{zad}');
title(sprintf('Dzia³anie uk³adu z regulatorem typu %s', alg_type));
xlabel('k');
ylabel('y');
...
figure(99);
title('Dzia³anie uk³adu z ró¿nymi regulatorami');
stairs(1:sim_time,y_zad);
legend('y_{zad}');
xlabel('k');
ylabel('y');
...
figure(99);
hold on;
stairs(1:sim_time,y_vector,'DisplayName',alg_type);
hold off;

figure(98);
hold on;
stairs(1:sim_time,u_vector,'DisplayName',alg_type);
hold off;
